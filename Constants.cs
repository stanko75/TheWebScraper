namespace TheWebScraper
{
    static class Constants
    {
        public static class Db
        {
            ...
            public const string etageNummer = "etageNummer";
            public const string etageVon = "etageVon";
            public const string typ = "typ";
            public const string wohnflaeche = "wohnflaeche";
            public const string bezugsfrei = "bezugsfrei";
            public const string bonitaetsauskunft = "bonitaetsauskunft";
